...
class Test1Reviewb extends StatelessWidget {
  const Test1Reviewb({super.key});
      ...
      body: Center(
        ...
        child: Column(
          children: [
            ...
            Row(
              children: [
                ...
                Container( width: 50, height: 50, color: Colors.brown,
                    child: Text('Vince Ngitit' , style: TextStyle(fontSize: 12),) ),
            ...
            Row(
              children: [
                ...
                Container( width: 50, height: 50, color: Colors.deepOrange,
                    child: Text('Vince Ngitit' , style: TextStyle(fontSize: 12),) ),
                SizedBox(width: 100),  // 100 pixel sized box for 2 spaces
                Container( width: 50, height: 50, color: Colors.deepOrange,
                    child: Text('Vince Ngitit' , style: TextStyle(fontSize: 12),) ),
                Container( width: 50, height: 50, color: Colors.grey,
                    child: Text('Vince Ngitit' , style: TextStyle(fontSize: 12),) ),
            ...
            Row(       // MORE EFFICIENT WAY <|============================================================
              children: [
                SizedBox(width: 0), // empty box for space
                Container( width: 50, height: 50, color: Colors.grey,
                    child: Text('Vince Ngitit' , style: TextStyle(fontSize: 12),) ),
                SizedBox(width: 50),
